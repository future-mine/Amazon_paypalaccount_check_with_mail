...
for email in emails:
	...
	if "You indicated you are a new customer, but an account already exists with the e-mail" in cek:
		...
		live.write(email + '\n')
	elif "Enter the characters as they are given in the challenge" in cek:
		print("\033[33;1mBLOCK\033[0m | "+email+" | [(Blocked)]")
		block.write(email + '\n')
